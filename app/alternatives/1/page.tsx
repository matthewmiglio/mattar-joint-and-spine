{/* Alternative 1: Classic Elegance — Dark/Gold cinematic luxury */}

import Link from 'next/link';

export default function Alt1() {
  return (
    <div className="bg-[#0a0a0a] text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1.05] tracking-tight">
            True Healing Starts
            <br />
            <span className="text-[#C8A96E] italic">With Your Body</span>
          </h1>
